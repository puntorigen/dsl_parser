  ...
  class dsl_parser {
    ...
    */
    ...
    getNode() {
      ...
      return _asyncToGenerator(function* () {
        var {
          id = _this3.throwIfMissing('id - getNode'),
          recurse = true,
          justlevel,
          dates = true,
          $ = false,
    ...
    */
    ...
    getParentNode() {
      ...
      return _asyncToGenerator(function* () {
        var {
          id = _this4.throwIfMissing('id - ParentNode'),
          recurse = false
    ...
    */
    ...
    getParentNodesIDs() {
      ...
      return _asyncToGenerator(function* () {
        var {
          id = _this5.throwIfMissing('id - ParentNodesIDs'),
          array = false
    ...
    */
    ...
    getChildrenNodesIDs() {
      ...
      return _asyncToGenerator(function* () {
        var {
          id = _this6.throwIfMissing('id - ChildrenNodesIDs'),
          array = false
    ...
    */
    ...
    getBrotherNodesIDs() {
      ...
      return _asyncToGenerator(function* () {
        var {
          id = _this7.throwIfMissing('id - BrotherNodesIDs'),
          before = true,
          after = true,
          array = false
    ...
    */
    ...
    createGitVersion(extrastep) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = _this8.$.html(); // 8) extrastep


        if (extrastep && typeof extrastep == 'function') {
          resp = extrastep(_this8.$);
        }
