        ...
        var changes = /*#__PURE__*/function () {
          var _ref7 = _asyncToGenerator(function* (source, target) {
            ...
            for (var line in resp) {
              ...
              var operator = content.shift(); //console.log('operador:'+operator);
                  ...
                  for (var i = line; i >= 0; i--) {
...

                    {
                      ...
                      if (to_check != '' && to_check.includes('ID_') == true) {
                        var _test = extract("id=\"ID_{id}\"", to_check); //console.log('checking for ID',{to_check,test});
            ...
            for (var _x13 in report.deleted) {
              if (opts.source.includes(_x13) == false && opts.diff.includes(_x13) == true) {
                report.added[_x13];
            ...
            for (var _x14 in report.modified) {
              if (opts.diff.includes(_x14) == false) {
          ...
          return function changes(_x11, _x12) {
