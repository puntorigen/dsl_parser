(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.dslparser = {}));
  ...
  */
            ...
            var _ref = _asyncToGenerator(function* (i, elem) {
              ...
              if (typeof cur.attr('ID') != 'undefined') {
                ...
                if (all_met && attribute && fmatch != 'attribute') {
                  ...
                  _tmp5.attributes.map(function (x) {
                ...
                if (all_met && attribute_value && fmatch != 'attribute_value') {
                  ...
                  _tmp5.attribute_value.map(function (x) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var nodes = yield me.$('node[ID=' + id + ']').each( /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator(function* (i, elem) {
            ...
            if (typeof cur.attr('TEXT') != 'undefined') resp.text = cur.attr('TEXT'); // dates parsing
        ...
        if (!justlevel) delete resp.valid; // reply
  ...
  function numberInCondition(num, test2) {
    var resp = true,
        test = isNaN(test2) ? test2 : test2.toString();
